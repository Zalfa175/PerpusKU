...
<head>
  ...
  <title>PerpusKU | Data Peminjaman Buku</title>
                            ...
                            <td>
                              <div class="btn-group">
                                <button type="button" class="btn btn-warning btn-xs">
                                  <a class="text-light" href="input_kembali.php?id=<?php echo $row['id'] ?>">Kembalikan</a>
                                </button>
                                <button type="button" class="btn btn-info btn-xs">
                                  <a class="text-light" href="input_loans.php?id=<?php echo $row['id'] ?>">Edit</a>
                                </button>
                                <button type="button" class="btn btn-danger btn-xs">
                                  <a class="text-light" href="controller/delete_loans.php?id=<?php echo $row['id'] ?>">Hapus</a>
                                </button>
                              </div>
                            </td>
                        </tr>
